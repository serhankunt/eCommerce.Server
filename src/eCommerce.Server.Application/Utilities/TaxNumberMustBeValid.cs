...
public class TaxNumberMustBeValid<T> : PropertyValidator<T, string>
{
    public override string Name => "Tax Number Must Be Valid";

    public TaxNumberMustBeValid()
    {
    ...
    public override bool IsValid(ValidationContext<T> context, string value)
    {
        ...
        if(value.Length == 10)
        {
            //Vergi numarası kontrol algoritması
    ...
    {
        return "You need to enter {PropertyName} a valid tax number.";
    }
}
